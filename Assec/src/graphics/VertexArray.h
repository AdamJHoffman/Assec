...
namespace assec::graphics
{
	...
	public:
		...
		INLINE CONST_REF(Buffer<unsigned char>) getVertexBuffer() const { return *this->m_VertexBuffer; }
		INLINE CONST_REF(Buffer<uint32_t>) getIndexBuffer() const { return *this->m_IndexBuffer; }
		INLINE REF(Buffer<unsigned char>) getVertexBuffer() { return *this->m_VertexBuffer; }
		INLINE REF(Buffer<uint32_t>) getIndexBuffer() { return *this->m_IndexBuffer; }
