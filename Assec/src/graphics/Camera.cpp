...
{
	OrthographicCamera::OrthographicCamera(float left, float right, float bottom, float top, float znear, float zfar) : Camera::Camera(glm::ortho(left, right, bottom, top, znear, zfar)) {}
